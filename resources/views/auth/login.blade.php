                    ...
                    <form method="POST" action="{{ route('login') }}" class="mt-10">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between mt-4 md:mt-6">
                            <div class="flex items-center">
                                <input id="remember_me" name="remember" type="checkbox" value="on" {{
                                ...
                                <label for="remember_me"
                                    class="ml-2 text-sm font-medium text-gray-800">Recuérdame</label>
                            </div>

                            @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}"
                                class="mt-2 md:mt-0 text-sm text-blue-700 font-semibold">¿Olvidaste tu contraseña?</a>
                            @endif
